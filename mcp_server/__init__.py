...
Tool Categories:
  - Creator (5): get_creator_profile (bundled with persona), get_active_creators,
                 get_allowed_content_types, get_content_type_rankings, get_persona_profile
...
Optimization Note:
  - get_creator_profile now bundles persona data (include_persona=True by default)
  - Preflight reduced from 4 MCP calls to 3
...
"""
__version__ = "1.5.0"  # Updated for persona bundling
