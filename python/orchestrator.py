...
class MCPClient(Protocol):
    ...
    async def get_allowed_content_types(self, creator_id: str) -> dict: ...
...
INDEPENDENCE: Re-fetch allowed types/avoid via MCP (get_allowed_content_types, get_content_type_rankings).
